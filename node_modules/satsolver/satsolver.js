/* SATSolver written by André Ferreira and Lucas Rodrigues*/
...
//Indices globais para o nextAssignment
let indice = 0;
let indicemax;
let indice2;

//Função recursiva para produzir o nextAssignment
...
function readFormula(fileName) {
  ...
  function checkProblemSpecification(text, clauses, variables) {
      ...
      if (hasp===true) { //checa se realmente existe a linha com o "p", e se não tiver, retorna o checkProblemSpecification como true.
